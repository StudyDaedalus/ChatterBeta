...
public class ChatListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        TextView tvLastChatRecord=(TextView)convertView.findViewById(R.id.lvRow_lastChatRecord);
        TextView tvLastChatTime=(TextView)convertView.findViewById(R.id.lv_Row_lastChatTime);
        ...
        ivExpandRelation.setImageResource(R.drawable.ic_menu_emotions);
